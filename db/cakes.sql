...
(131, 'Chocolate Roll', 80, 77, 300, 50, 350, '2019-03-16', 1, 46, 22, '100', 'available');
...
(34, 1596645037, '2020-08-05', 41, '100', 1, 350, 350);
...
(20, 1596645037, '2020-08-05', 41, 150, 500, 'Confirmed', 'Your order has been confirmed!', '2020-08-02');
...
(41, 'suraj', 'ghosh', 'suraj@gmail.com', 0, 'chanditala,hooghly', 'Customer', 'suraj', '$2y$10$aNkErjoH0U0OXosBppmrJ.ahAIARnQ57fPQsSHh13AOX0z5RCUAz.'),
(42, 'suraj', 'ghosh', 'suraj@yahoo.com', 0, '', 'Admin', 'adminsuraj', '$2y$10$3nizFcPQzYQQfXSKGDmXOeyOJ1ZUJmxoo0uqAlGRp6XOFEO7ISrFG');
...
--
ALTER TABLE `tbltransac`
  MODIFY `transac_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
